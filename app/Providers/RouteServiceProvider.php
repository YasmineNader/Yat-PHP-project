...
class RouteServiceProvider extends ServiceProvider
{
    ...
    protected function mapRoomsRoutes()
    {
        Route::middleware('rooms')
            ->namespace($this->namespace)
    ...
    {
        Route::middleware('contactus')
            ->namespace($this->namespace)
            ->group(base_path('routes/contactus.php'));
    }
    ...
    protected function mapInformationRoutes()
    {
